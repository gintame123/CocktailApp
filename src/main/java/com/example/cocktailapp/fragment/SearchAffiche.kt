...
class SearchAffiche : Fragment(){


    private lateinit var binding : AfficheRechercheBinding
    private var urlId = ""
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.affiche_recherche, container, false)
        ...
        random.enqueue(object : Callback<ListOfDrink> {
            override fun onResponse(call: Call<ListOfDrink>, response: Response<ListOfDrink>) {
                ...
                if (responseFromJson?.drinks?.size!! > 0) {
                    ...
                    binding.instructionView.setMovementMethod(ScrollingMovementMethod())
                }
            }
